 ...
 * 所以这里手写 travelAtlas 对 src/data/travel-map.sample.json 的【已知输出】作为 fixture。
...
// ---------------------------------------------------------------------------
// 样例数据 fixture —— travelAtlas.ts 对 travel-map.sample.json 的已知输出
// ---------------------------------------------------------------------------
...
const JOURNEY_ID = '2025-north-atlantic-demo'
const TRIP_TITLE = '2025 North Atlantic Demo'

const sampleJourneyDays = (): JourneyDay[] => [
  {
    id: 'sample_reykjavik',
    date: '2025-06-01',
    countryId: 'iceland',
